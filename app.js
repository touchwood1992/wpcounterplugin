(function(factory) {
  ...
  function mergeOptions(timer, opts) {
    ...
    (timer._options.classNameSeconds = classNames.seconds || "jst-seconds"),
      ...
      (timer._options.classNameClearDiv =
        classNames.clearDiv || "jst-clearDiv"),
  ...
  Timer.prototype.start = function(options) {
    ...
    var createSubElements = function(timerBoxElement) {
      ...
      // GET TOTAL SECONDS
      /**================================================================================== */
      const numberofSecond = that.fetchSecondsLeft(timerBoxElement);
      /**================================================================================== */
      // GET HOURS MINUTES AND SECONDS
      /**================================================================================== */
      const hour_minute_seconds = that.formatTimeLeft(numberofSecond);
      h = hour_minute_seconds[0];
      m = hour_minute_seconds[1];
      s = hour_minute_seconds[2];
      ...
      timerBoxElement
        .parent()
        .find(".timer-btn--timerresume")
        .hide();
      timerBoxElement
        .parent()
        .find(".timer-btn--timerpause")
        .hide();
    ...
    this.targetElement.each(
      function(_index, timerBox) {
        ...
        timerBoxElement.on("resetime", function() {
          ...
          var secondsLeft =
            options.secondsLeft || that.fetchSecondsLeft(timerBoxElement);
  ...
  Timer.prototype.startCountdown = function(element, options) {
    ...
    if (element.onReset != false) {
      ...
      element.onReset.on("click", function() {
        ...
        if (element.onStart) element.onStart.show();
        if (element.onPause) element.onPause.hide();
        if (element.onReset) element.onReset.hide();
      });
    }
    ...
    if (element.onStart != false) {
      element.onStart.on("click", function() {
        ...
        if (element.onStart) element.onStart.hide();
        if (element.onPause) element.onPause.show();
        if (element.onReset) element.onReset.show();
      });
    }
  };
  ...
  Timer.prototype.setFinalValue = function(finalValues, element) {
    ...
    element
      .find("." + this._options.classNameSeconds)
      .html(
        finalValues.pop() +
          "<span class='timer-label'>" +
          getLabels.seconds +
